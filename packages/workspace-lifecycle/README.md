...
invocation outside the target worktree. It verifies the target contains only
tracked regular content, asks Git to remove the linked worktree, and preserves
